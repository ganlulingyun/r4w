...
- **GNU Radio Feature Parity (Batches 13-57)** — 225+ new DSP modules bringing the total to ~257+ standalone blocks with ~2820+ unit tests:
  ...
  - All blocks wired into the visual pipeline builder (now 273+ blocks) with property editors and block metadata
