...
- **GNU Radio Feature Parity (Batches 13-45)** — 170+ new DSP modules bringing the total to ~197+ standalone blocks with ~2150+ unit tests:
  ...
  - All blocks wired into the visual pipeline builder (now 233+ blocks) with property editors and block metadata
