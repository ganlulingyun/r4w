...
- **GNU Radio Feature Parity (Batches 13-51)** — 195+ new DSP modules bringing the total to ~227+ standalone blocks with ~2500+ unit tests:
  ...
  - All blocks wired into the visual pipeline builder (now 243+ blocks) with property editors and block metadata
