...
- **GNU Radio Feature Parity (Batches 13-50)** — 190+ new DSP modules bringing the total to ~222+ standalone blocks with ~2443+ unit tests:
  ...
  - All blocks wired into the visual pipeline builder (now 238+ blocks) with property editors and block metadata
