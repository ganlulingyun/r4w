...
- **GNU Radio Feature Parity (Batches 13-44)** — 165+ new DSP modules bringing the total to ~192+ standalone blocks with ~2090+ unit tests:
  ...
  - All blocks wired into the visual pipeline builder (now 228+ blocks) with property editors and block metadata
