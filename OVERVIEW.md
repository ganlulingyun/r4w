...
- **GNU Radio Feature Parity (Batches 13-58)** — 230+ new DSP modules bringing the total to ~262+ standalone blocks with ~2870+ unit tests:
  ...
  - All blocks wired into the visual pipeline builder (now 278+ blocks) with property editors and block metadata
