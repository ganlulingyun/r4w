...
- **GNU Radio Feature Parity (Batches 13-43)** — 160+ new DSP modules bringing the total to ~187+ standalone blocks with ~2030+ unit tests:
  ...
  - All blocks wired into the visual pipeline builder (now 223+ blocks) with property editors and block metadata
