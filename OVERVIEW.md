...
- **GNU Radio Feature Parity (Batches 13-186) — 858+ new DSP modules bringing the total to 933 standalone blocks:
  ...
  - Batch 19: FM Modulator (continuous-phase + FSK), Peak Detector (parabolic interpolation), Integrate & Dump, Rail (clamp), Threshold Detector, Mute, Valve (gate)
  ...
  - Batch 34: Patterned Interleaver (custom-pattern stream interleaving/deinterleaving of N streams, f64 and bytes), Bitwise Ops (XOR/AND/OR/NOT for byte and boolean streams, hamming_distance, popcount, parity), Peak Hold (signal peak tracking with exponential decay, PeakHold/AbsPeakHold/PeakHoldDb), Multiply Matrix (complex and real matrix-vector multiplication, identity/scalar/diagonal/from_rows), GLFSR Source (Galois and Fibonacci LFSR PN sequence generators, maximal-length polynomials 2-31 bits, bits/bools/bipolar output)
  ...
  - Batch 43: LDPC Codec (sparse parity-check matrices, sum-product and min-sum belief propagation decoding, proto-matrix expansion, systematic encoding), Welch PSD (overlapped windowed averaged periodograms, Hann/Hamming/Blackman/Rectangular windows, occupied_bandwidth/noise_floor/spectral_flatness), MIMO (Alamouti 2x1 STBC, ChannelMatrix Hermitian transpose, ZF/MMSE spatial demux, MRT beamforming, capacity calculation), RDS Decoder (IEC 62106 FM Radio Data System: PS/RT/PTY/CT decoding, syndrome-based error correction, 32 PTY names), APRS Decoder (amateur radio 144.390 MHz: TNC2 parsing, position/message/weather/status/telemetry, AX.25 callsign decoding)
  - Batch 44: Vocoder (LPC-10/CODEC2/CVSD/mu-law voice codecs, Levinson-Durbin LPC analysis, autocorrelation pitch detection, all-pole synthesis), Channel Sounder (MLS/chirp probing, CIR estimation, power delay profile, RMS delay spread, Doppler spectrum, coherence bandwidth, K-factor), DAB+ (ETSI EN 300 401 digital audio broadcast receiver, Mode I-IV OFDM, DQPSK, frequency deinterleaving, null symbol detection, CFO estimation, FIC parsing, VHF Band III), PAPR Reduction (clipping & filtering, SLM, Tone Reservation, ACE, CCDF curves, EVM measurement), Beamformer (delay-and-sum, MVDR/Capon, MUSIC DOA, ULA/UCA geometries, steering vectors, covariance estimation)
  - Batch 45: PFB Arbitrary Resampler (polyphase filterbank arbitrary resampler, linear interpolation between branches, Blackman-Harris prototype, derivative filters), Cyclic Autocorrelation (cyclostationary signal analysis, spectral correlation function, feature detection, modulation classification CW/BPSK/QPSK/AM/FM/OFDM), Random PDU Generator (test traffic with Poisson/Uniform/Fixed inter-arrival, seeded LCG PRNG, traffic statistics), MMSE Interpolator (8-tap MMSE FIR fractional delay, 128-step mu quantization, windowed-sinc with Nuttall window, cubic/linear helpers), Fractional Delay (Thiran all-pass IIR and Lagrange FIR fractional sample delay, maximally flat group delay)
  - Batch 46: Linear Equalizer (adaptive FIR equalizer with LMS/RLS/CMA/Kurtotic algorithms, training and decision-directed modes, constellation slicing), Trellis Coding (FSM-based trellis encoder + Viterbi decoder for TCM and convolutional codes, generator polynomial construction), Protocol Formatter (pluggable HeaderFormat trait, DefaultHeaderFormat with access code + repeated length + CRC, CounterHeaderFormat, protocol formatter/parser blocks), CTCSS Squelch (sub-audible tone encoder/decoder for FM repeater access, Goertzel detection, 38 standard EIA/TIA tones), OFDM Frame Equalizer (per-subcarrier ZF/MMSE equalization with pilot-based channel estimation, linear interpolation)
  - Batch 47: Power Amplifier Model (nonlinear PA behavioral models: Saleh/Rapp/Ghorbani/polynomial/limiter with AM/AM and AM/PM distortion, P1dB compression point), Digital Pre-Distortion (memory polynomial DPD with LMS/RLS indirect learning architecture, NMSE performance metric), Median Filter (sliding-window median filter with dual-heap O(log n) algorithm, complex/weighted variants, 2D hybrid median for spectrogram denoising), CORDIC (hardware-efficient CORDIC rotator for sin/cos, atan2, polar/rect conversions, NCO, iterative shifts-and-adds algorithm), Tagged File Sink (stream-tag-triggered IQ file segmentation for burst recording)
  - Batch 48: CFAR Detector (CA-CFAR/GO-CFAR/SO-CFAR/OS-CFAR for 1D power data, Cfar2D for range-Doppler maps, CfarDetection struct with index/power/noise/test_statistic), Chirp-Z Transform (Bluestein's algorithm for arbitrary Z-plane contour evaluation, zoom_fft for high-resolution narrow-band spectral analysis, CztProcessor with cached parameters), Permute (vector index permutation with validation, inverse_permutation/compose/is_identity/bit_reversal, StreamPermuter for block-mode stream processing), Noise Reduction (spectral subtraction and Wiener filter MMSE, Hann windowing, exponential noise PSD smoothing), Savitzky-Golay Filter (polynomial smoothing and differentiation, least-squares local fit, cached coefficients, 5/7/9-point quadratic/quartic presets, peak shape preservation)
  - Batch 49: Sigma-Delta Converter (sigma-delta modulator/demodulator with error-feedback EFB structure, 1st/2nd/3rd order noise shaping, multi-bit quantizer, CIC sinc³ decimation filter for ADC, theoretical SNR formula, NTF magnitude), Farrow Resampler (Farrow polynomial structure for continuously variable fractional resampling, linear/quadratic/cubic interpolation via Horner evaluation, variable ratio on-the-fly, resample_to_length utility), Empirical Mode Decomposition (EMD via iterative sifting process + Hilbert-Huang Transform for non-stationary signal analysis, extracts IMFs Intrinsic Mode Functions, cubic spline envelope interpolation, instantaneous frequency and amplitude), Ambiguity Function (radar waveform delay-Doppler analysis, full 2D ambiguity surface |χ(τ,ν)|² computation, zero-Doppler and zero-delay cuts, LFM chirp and Barker code generators, mainlobe width measurement, complex signal support), Dynamic Range Compressor (compressor/limiter/expander/noise gate with attack/release envelope follower, soft knee, RMS/peak detection, makeup gain, static compression curve for visualization)
  - Batch 50: Teager-Kaiser Energy Operator (TKEO instantaneous energy Psi[x(n)] = x(n)^2 - x(n-1)*x(n+1), AM/FM demodulation via TKEO, streaming processor, transient detection), Wigner-Ville Distribution (WVD/PWVD/SPWVD time-frequency analysis, analytic signal computation, instantaneous frequency extraction, 2D time-frequency surface with marginals), Lattice Filter (lattice and lattice-ladder filter structures, Levinson-Durbin recursion, Burg's method for AR estimation, PARCOR coefficients, step-up/step-down recursion, lattice predictor, lattice-ladder ARMA filter, PSD from reflection coefficients, Line Spectral Frequencies), Prony's Method (parametric exponential signal modeling, standard and least-squares variants, matrix pencil method, companion matrix eigenvalue solver with QR iteration, MDL order estimation, parametric PSD), Cepstral Analysis (real/power/complex cepstrum with phase unwrapping, pitch detection via cepstral peak picking, homomorphic filtering for source-filter separation, MFCCs for speech/audio, mel filterbank, spectral envelope)
  - Batch 51: Blind Source Separation (FastICA with deflation, PCA whitening, 3 nonlinearities LogCosh/Exp/Cube, kurtosis, negentropy, correlation metrics), Phase Vocoder (STFT-based time-stretch, pitch-shift, spectrogram, robotize, whisperize effects with overlap-add synthesis), Compressive Sensing (OMP greedy and ISTA/FISTA proximal gradient sparse recovery from underdetermined systems, random/DCT sensing matrices, RIP constant estimation), Zero Crossing Detector (ZCR computation, frequency estimation, ZcrAnalyzer with energy, VoiceActivityDetector energy+ZCR with hangover, spectral centroid/flatness, modulation classification), Subspace Tracker (PAST/OPAST adaptive rank-d subspace tracking, projection, projection error, dimension estimation, subspace angle)
  - Batch 52: CIC Filter (CIC decimation/interpolation without multiplications, passband compensator FIR design), Overlap-Save (Overlap-Save and Overlap-Add streaming FFT block convolution, direct convolution reference), LMS Filter (Standard LMS, Normalized LMS NLMS, Leaky LMS adaptive filters for system identification and noise cancellation), STFT (Short-Time Fourier Transform with configurable windows Hann/Hamming/Blackman, Inverse STFT with OLA perfect reconstruction, COLA constraint checking), MUSIC DOA (MUSIC direction-of-arrival estimation with Hermitian eigendecomposition augmented real form + Jacobi, MDL/AIC source enumeration, test snapshot generation)
  - Batch 53: RAKE Receiver (RAKE multipath combining for DSSS/CDMA with MRC, equal-gain, selection diversity, finger management, delay estimation), Modulation Classifier (automatic modulation classification via higher-order cumulants C20/C40/C42, kurtosis, sigma_af feature extraction), TDOA Estimator (Time Difference of Arrival geolocation with GCC-PHAT cross-correlation, iterative least-squares solver), FM Stereo Decoder (FM stereo multiplex decoder with 19 kHz pilot PLL, 38 kHz DSB-SC demodulation, de-emphasis filter), Phase Noise Model (oscillator phase noise synthesis from L(f) PSD masks and Leeson model, configurable noise floor and corner frequencies)
  - Batch 54: OFDM Schmidl-Cox Sync (OFDM symbol timing and coarse/fine CFO estimation using delayed autocorrelation with half-symbol repetition detection, timing metric M(d)=|P(d)|^2/R(d)^2, preamble generator), OFDM Carrier Allocator (subcarrier mapping TX/RX with CarrierAllocator and CarrierSerializer, WiFi 802.11a 48 data + 4 pilot and LTE resource block presets, guard bands, DC null), Trellis Metrics (branch metric computation for Viterbi/BCJR decoding: Euclidean, squared Euclidean, Manhattan, Hamming hard/soft, ViterbiCombined integrated path search, metrics_to_llr soft output), Link Budget (RF link budget calculator with builder pattern for TX power/antenna gains/FSPL/atmospheric loss/NF/bandwidth, cascaded receiver NF via Friis formula, thermal noise floor, max range estimation), FEC Generic API (unified FEC framework with GenericEncoder/GenericDecoder traits, streaming FecEncoderBlock/FecDecoderBlock with automatic block framing, AsyncFecEncoder/AsyncFecDecoder for PDU mode, FecCodecRegistry for runtime codec selection, built-in Repetition and ParityCheck codecs)
  - Batch 61: Adaptive Filter RLS (RLS adaptive filter with O(N²) matrix updates, exponential forgetting factor lambda, inverse covariance matrix recursion, step-size normalization, convergence acceleration for echo cancellation/equalization), Signal Generator (multi-waveform test source: Tone, TwoTone, Chirp, Noise, Impulse, Square, Sawtooth, DC with configurable amplitude/frequency/phase), IQ Imbalance Estimator (statistical moments-based IQ gain/phase imbalance estimation, Imbalance Ratio IRR calculation, estimator convergence tracking), Packet Decoder (generic sync-word detection + configurable field extraction with Fixed/Length/Payload/CRC field types, packet framing and validation), Multi-Rate Clock (accumulator-based multi-domain clock divider/multiplier, NCO-style phase accumulation, frequency control without explicit counter logic)
  - Batch 60: Noise Figure (Friis cascaded noise figure formula, sensitivity/MDS calculation, receiver thermal noise floor, cascade stage contributions), AIS Encoder (AIS position report encoder with HDLC bit-stuffing framing, CRC-16 CCITT, NRZI encoding for maritime messaging), Moving RMS (sliding window RMS with O(1) incremental update, crest factor and peak tracking), Complex to Interleaved (bidirectional (I,Q) tuple ↔ interleaved conversion, multi-format support cf64/cf32/ci16/ci8/cu8 for SDR hardware), Sample Rate Converter (polyphase FIR rational L/M resampler with automatic rate finding, anti-aliasing filters, configurable filter order)
  - Batch 59: Digital Up Converter (DUC with CIC interpolation, FIR compensation filter, NCO mixer for baseband-to-IF upconversion, complements DDC), Sigma-Delta Modulator (sigma-delta modulation/demodulation for ADC/DAC with configurable order 1st-3rd and oversampling ratio), Reed-Solomon Codec (RS encoder/decoder over GF(2^8) with generator polynomial 0x11D, configurable t-symbol error correction), FMCW Radar (FMCW radar processor with chirp generation, beat frequency mixing, range/Doppler FFT processing, range-Doppler map, automotive 77 GHz preset), Viterbi Decoder (convolutional encoder rate 1/n with hard/soft Viterbi decoding, traceback, NASA k=7 and GSM k=5 presets)
  - Batch 58: Polar Code (Arikan's 5G NR polar codes, PolarEncoder butterfly polar transform, PolarDecoder recursive SC decoding with f/g-function factor graph traversal, Bhattacharyya channel reliability ordering), MSK Modulator (MSK h=0.5 continuous-phase FSK modulator/demodulator, GMSK variant with configurable BT product Gaussian pre-filter, phase-accumulation demodulation, GSM/satellite), OQPSK Modulator (Offset QPSK modulator/demodulator, Q channel delayed by T/2 limiting phase transitions to +-pi/2, PAPR analysis, ZigBee 802.15.4/CDMA IS-95), Frequency Hopping (FHSS controller, HopPattern: Pseudorandom LFSR/Sequential/Fixed/Adaptive with blacklist, Bluetooth 79ch 1600 hops/s and military HF presets, processing gain), Digital Down Converter (DDC with NCO mixer, 3-stage CIC decimation, windowed-sinc Hamming FIR compensation filter, retuning, reset)
  - Batch 57: ESPRIT DOA (ESPRIT direction-of-arrival estimation with LS/TLS variants, ULA steering vectors, rotation matrix extraction, complements MUSIC DOA), Convolutional Interleaver (Forney-type convolutional interleaver/deinterleaver, DVB-S2 I=12/M=17 and GSM I=4/M=19 presets, shift-register delay structure, burst error dispersal), Unscented Kalman Filter (UKF with UkfModel trait for nonlinear state estimation, Merwe scaled sigma points, predict/update cycle, NEES consistency metric, constant-velocity/coordinated-turn presets), SAR Processor (Range-Doppler Algorithm for SAR imaging, range compression, RCMC range cell migration correction, azimuth compression, point target generation, Doppler centroid estimation), WOLA Channelizer (Weighted Overlap-Add analysis/synthesis filterbank, Hann/Hamming/Blackman/Kaiser windows, configurable overlap, channel frequency response, near-perfect reconstruction)
  - Batch 56: Adaptive ModCod (Adaptive Modulation and Coding link adaptation engine, DVB-S2 ACM 28-entry modcod table per ETSI EN 302 307-1, LTE CQI 15 entries per 3GPP TS 36.213, Wi-Fi MCS 10 entries for 802.11n/ac, strategies: MaxThroughput/MaxReliability/TargetEfficiency, hysteresis/EMA SNR averaging/backoff margin), MIMO Detector (Schnorr-Euchner sphere decoder, K-best tree search, exhaustive ML, MMSE-SIC MIMO detection, QR decomposition via modified Gram-Schmidt, soft LLR output max-log approximation, ConstellationSet QPSK/16QAM/64QAM/256QAM, ChannelMatrix Hermitian/mat_mul), Doppler Pre-Correction (satellite Doppler pre-compensation, profiles: Constant/LinearRamp/Polynomial/Tabulated, phase-continuous NCO correction, Doppler rate computation, for LEO satellite comms Iridium/Starlink and deep-space links), Cognitive Engine (dynamic spectrum access decision engine, OODA loop for cognitive radio per IEEE 802.22, strategies: Greedy/EpsilonGreedy/UCB1/ThompsonSampling, SpectrumBand with BandPriority/RegulatoryStatus, PU detection/handoff/vacancy prediction/spectrum utilization), RaptorQ Code (RaptorQ erasure codes RFC 6330, systematic rateless codes with LDPC+HDPC pre-coding over LT inner code, near-zero reception overhead, 3GPP MBMS/ATSC 3.0/DVB-H, RaptorQEncoder/RaptorQDecoder with belief propagation peeling decoder)
  - Batch 55: Pulse Compressor (matched filtering for radar with LFM chirp/Barker/polyphase code references, Hamming/Chebyshev/Taylor sidelobe windows, time-domain and FFT-domain processing, processing gain, range resolution), MTI Filter (Moving Target Indication/Detection for pulsed radar, single/double/triple cancellers, binomial weights, custom FIR slow-time filters, DopplerFilterBank for MTD with windowing, blind speed calculation), Fountain Code (Luby Transform rateless erasure codes for broadcast/multicast, ideal/robust soliton degree distributions, belief propagation peeling decoder, streaming encode/decode with deterministic PRNG), Cross-Ambiguity Function (passive bistatic radar CAF, direct and batched correlation, LMS/NLMS/ECA-B direct-path interference cancellation, target detection with SNR estimation, bistatic range conversion), Feedforward Timing Estimator (non-data-aided burst-mode timing recovery, Oerder-Meyr spectral line/M-th power/squaring/Gardner feedforward algorithms, linear/cubic/Farrow/sinc interpolation)
  - Batch 62: Stream Demultiplexer (demux single stream to N based on metadata), Tagged Stream Align (synchronize aligned frame streams), PDU Set (PDU metadata key-value assignment), Moving Variance (O(1) sliding window variance calculator), Vector to Stream (convert vectors to sample-by-sample streaming)
  ...
  - Batch 116: Free Space Optical Channel (FSO turbulence and scintillation channel model), LoRaWAN MAC Scheduler (LoRaWAN Class A/B/C MAC layer scheduling), Phase Locked Loop Biquad (biquad-based PLL with configurable loop bandwidth), Millimeter Wave Beamforming (mmWave phased array beamforming for 5G NR), IEEE 802.15.4 ZigBee Frame Parser (ZigBee/802.15.4 MAC frame parsing and construction)
  - Batch 117: Linear Congruential Whitener (LCG-based data whitening/scrambling), Automatic Modulation Classifier (blind modulation recognition via feature extraction), Polyphase Golay Correlator (efficient Golay complementary sequence correlation), Power Law Spectrum Estimator (power-law spectral density estimation), Lagrange Polynomial Interpolator (Lagrange polynomial interpolation for sample reconstruction)
  - Batch 118: Incoherent Detector (non-coherent energy detection for signal presence), CSAC Reference Oscillator (chip-scale atomic clock reference modeling), Parametric Doppler Estimator (parametric Doppler shift estimation for moving targets), Multipath Profile Extractor (multipath channel profile extraction and characterization), Frequency Hopping Controller (FH sequence generation and hop timing control)
  - Batch 119: Optical Coherent Receiver (coherent optical receiver with digital signal processing), Bio ECG Arrhythmia Classifier (ECG arrhythmia detection and classification), Synthetic Aperture Sonar (SAS image formation for underwater imaging), Geomagnetic Storm Detector (geomagnetic disturbance detection from magnetometer data), Music Pitch Tracker (musical pitch detection and tracking)
  - Batch 120: Photoacoustic Image Reconstructor (photoacoustic tomography image reconstruction), Industrial Process Modulation (process control signal modulation and demodulation), Acoustic Emission Sensor (acoustic emission event detection for structural monitoring), RF Mitigation Adaptive Nulling (adaptive null steering for RF interference mitigation), Weather Radar Clutter Suppressor (ground clutter suppression for weather radar)
  - Batch 121: Radiation Detector Processor (nuclear radiation pulse processing and spectroscopy), Powerline Carrier Modem (power line communication modem signal processing), RFID Backscatter Receiver (RFID tag backscatter signal demodulation), Inertial Nav Processor (INS mechanization and error state Kalman filter), Acoustic Beamformer Adaptive (adaptive acoustic beamforming for microphone arrays)
  ...
  - Batch 151: Plasma Diagnostics Processor (Langmuir probe I-V/electron temperature), Quantum Annealing Optimizer (Ising/QUBO/simulated annealing), Geophone Signal Processor (seismic reflection/velocity analysis), Optical Tweezers Controller (trap stiffness/particle tracking), Neutron Diffraction Analyzer (Rietveld refinement/d-spacing)
  - Batch 152: Acoustic Emission Localizer (AE source location/velocity calibration), X-Ray Fluorescence Analyzer (XRF elemental quantification/matrix correction), Magnetohydrodynamic Flow Meter (MHD Lorentz force/conductivity), Quantum Dot Spectroscopy (photoluminescence/quantum confinement), Seismic Ambient Noise Tomographer (cross-correlation/Green's function)
  ...
  - Batch 159: Ellipsometry Analyzer (Fresnel/transfer matrix/Cauchy/Sellmeier/Drude), Schlieren Imaging Processor (refractive index gradient/knife-edge/Abel inversion), Seismic Velocity Inversion (NMO/semblance/Dix/SIRT tomography), Cardiac Electrogram Mapper (activation time/voltage mapping/rotor detection/CFAE), Magneto-Optical Trap Controller (Doppler cooling/MOT dynamics/saturated absorption)
  ...
  - Batch 179: Thermogravimetric Evolved Gas Analyzer (TGA-EGA mass%, DTG derivative, Kissinger activation energy, Ozawa-Flynn-Wall, TGA-MS correlation), Differential Pulse Voltammetry Processor (DPV/SWV differential current, Parry-Osteryoung peak current, half-peak width, LOD/LOQ, Nernst), Inductively Coupled Plasma Torch Processor (ICP-OES emission line database, Boltzmann distribution, two-line temperature, Stark broadening, Saha ionization, Voigt profile), Scanning Tunneling Microscope Processor (STM tunneling current, apparent barrier height, plane subtraction, line leveling, roughness Ra/Rq/Rmax/Rsk/Rku, dI/dV spectroscopy, band gap), Neutron Activation Analysis Processor (NAA activation equation, decay/saturation/counting factors, comparator method, k0 standardization, Gaussian peak fitting, Currie detection limit) (898 total)
  - Batch 180: X-Ray Photoelectron Spectroscopy Processor (XPS binding energy, chemical shift, Shirley/Tougaard/linear backgrounds, Scofield sensitivity factors, Auger parameter, Doniach-Sunjic line shape, overlayer thickness, charge correction, IMFP estimate), Atomic Force Microscope Processor (AFM force-distance curves, Hertz/DMT/JKR modulus, adhesion force, plane subtraction, line leveling, roughness Ra/Rq/Rmax/Rsk/Rku/Rz, grain analysis, PSD, bearing ratio, tip deconvolution, Sader/thermal calibration), Raman Confocal Microscope Processor (Stokes/anti-Stokes temperature, depolarization ratio, Lorentzian/Gaussian/Voigt peak fitting, polynomial fluorescence removal, Savitzky-Golay smoothing, cosmic ray removal, SERS enhancement factor, Bose-Einstein correction), Cathodoluminescence Imaging Processor (CL band gap from onset, Varshni temperature dependence, Kanaya-Okayama penetration depth, dead layer estimation, thermal quenching, quantum efficiency, semiconductor presets), Electron Energy Loss Spectroscopy Processor (EELS zero-loss peak, log-ratio thickness, plasmon peaks, power-law background, core-loss edge extraction, Kramers-Kronig dielectric function, Fourier-log deconvolution, Malis MFP, hydrogenic cross-section) (903 total)
  - Batch 181: Auger Electron Spectroscopy Processor (AES derivative spectra, peak-to-peak quantification via sensitivity factors, Auger parameter, sputter depth profiling, backscatter correction, IMFP estimation, linear background subtraction, chemical shift), Ellipsometry Thin Film Processor (spectroscopic ellipsometry with Fresnel equations, Parratt recursion for multilayers, Cauchy/Sellmeier/Drude optical models, psi/delta computation, Brewster angle, pseudo-dielectric function, thickness estimation), Photoluminescence Lifetime Analyzer (TRPL single/bi/stretched exponential decay fitting, amplitude/intensity-weighted average lifetime, radiative/non-radiative rates, Stern-Volmer quenching, FRET efficiency/distance, Arrhenius activation energy, Stokes shift), Energy Dispersive X-Ray Processor (EDX/EDS X-ray line database, peak identification, Kramers background, Cliff-Lorimer quantification, ZAF matrix correction, Philibert absorption, electron range, X-ray generation depth, detection limits, dead time correction), Neutron Reflectometry Processor (Parratt recursion for multilayer reflectivity, SLD material database, Nevot-Croce roughness, Kiessig fringe analysis, Born approximation, contrast matching, D2O/H2O mixing, critical angle/Q) (908 total)
  - Batch 182: X-Ray Fluorescence Spectrometer (XRF fundamental intensities, matrix corrections, Moseley's law, Compton/Rayleigh ratio, bulk elemental analysis), Ion Mobility Spectrometry Processor (IMS Mason-Schamp equation, drift mobility, FT-IMS, peak deconvolution, CCS database, gas-phase ion separation), Coulometric Karl Fischer Processor (KF coulometric moisture titration, Faraday's law, endpoint detection, drift correction, control charts), Flame Atomic Absorption Processor (Flame AAS Beer-Lambert, method of additions, D2/Zeeman background correction, ionization interference), Scanning Probe Lithography Processor (SPL nanopatterning, Cabrera-Mott oxidation, DPN diffusion, thermal decomposition, Hertz/JKR contact mechanics) (913 total)
  - Batch 183: Atomic Emission Spectroscopy Processor (ICP-AES/OES Boltzmann distribution, 63 emission lines for 23 elements, Voigt profile, Saha ionization, plasma temperature, multi-element quantification), Superconducting Qubit Readout Processor (dispersive chi shift, IQ blob discrimination, assignment fidelity matrix, Purcell decay rate, T1/T2 measurement, crosstalk correction), Terahertz Time Domain Spectroscopy (THz-TDS radix-2 FFT, optical constants n+ik extraction, Drude/Lorentz dispersion models, water vapor absorption database, 8 material database entries), Microfluidic Droplet Sorter (capillary/Weber/Reynolds numbers, Poisson encapsulation statistics, impedance sensing, sort decision with latency compensation), MEMS Inertial Measurement Unit (Madgwick AHRS quaternion filter, complementary filter, Allan variance noise analysis, step detection, 6-position calibration) (918 total)
  - Batch 184: Nanoparticle Tracking Analysis (Brownian motion particle sizing via Stokes-Einstein, MSD analysis, diffusion coefficient, size distribution D10/D50/D90/PDI, concentration estimation, drift correction, solvent viscosity database), Brillouin Scattering Spectrometer (νB = 2nVs sin(θ/2)/λ elastic properties, Fabry-Perot interferometer with Airy function/FSR/finesse, 7-material database, Lorentzian/pseudo-Voigt fitting, spatial mapping), Plasma Etch Endpoint Detector (semiconductor OES endpoint detection, single-wavelength/ratio/derivative/PCA algorithms, 8 emission lines database, interferometric etch rate, over-etch control, SPC limits), Thermal Desorption Spectroscopy Analyzer (TDS/TPD surface kinetics, Polanyi-Wigner equation, Redhead/Kissinger methods, 0th/1st/2nd order desorption, peak deconvolution, 8-system database), Spin Echo NMR Processor (Hahn echo, CPMG T2, inversion recovery T1, Stejskal-Tanner diffusion, NNLS T2 distribution, well logging porosity/FFI/BVI/Timur-Coates permeability, 8-material database) (923 total)
  - Batch 185: Lock-In Amplifier Processor (dual-phase demodulation, time constant filtering, harmonic detection, noise rejection, phase-sensitive measurement), Magnetic Force Microscopy Processor (MFM domain imaging, lift-mode phase/frequency detection, quantitative analysis, tip-sample interaction modeling), Photothermal Deflection Spectroscopy (sub-bandgap absorption measurement, pump-probe configuration, thermal wave analysis, surface/bulk absorption separation), Scanning Near-Field Optical Microscope (SNOM/NSOM sub-wavelength imaging, aperture/apertureless modes, near-field to far-field conversion, tip enhancement), Streak Camera Temporal Analyzer (ultrafast time-resolved spectroscopy, sweep calibration, temporal profile extraction, jitter correction, multi-shot averaging) (928 total)
  - Batch 186: White Light Interferometry Profiler (VSI/PSI surface profiling, coherence envelope detection via FIR Hilbert analytic signal, five-point peak fitting, 4-step/5-step Hariharan phase shifting, roughness Ra/Rq/Rz/Rsk/Rku, areal Sa/Sq ISO 25178, PSD, tilt correction, Gaussian highpass filter, 4 material presets), Transmission Electron Microscopy Processor (TEM diffraction pattern analysis, d-spacing from camera calibration, zone axis identification, SAED ring indexing, HRTEM lattice fringe analysis via 2D DFT, CTF with Scherzer defocus and Thon ring detection, Wiener filter, thickness log-ratio EELS, moiré/Kikuchi analysis, 6-material database), Focused Ion Beam Processor (FIB milling/imaging, Sigmund sputter yield with Thomas-Fermi nuclear stopping, ion dose/mill depth, Gaussian beam+halo profile, curtaining correction, redeposition model, TEM lamella prep, FIB-SEM serial sectioning, SE channeling contrast, 52° dual-beam geometry, 8-material database, 4 ion species Ga+/Xe+/He+/Ne+), Atom Probe Tomography Analyzer (APT mass-to-charge TOF analysis, Kingham charge-state curves, Bas et al. point-projection reconstruction, mass spectrum binning, isotope library 28 isotopes, peak ranging, proxigram composition, maximum-separation cluster analysis with Guinier radius, binomial frequency distribution, 2D density maps, detection efficiency correction, 3 material presets), Glow Discharge Optical Emission Processor (GD-OES/Grimm source depth profiling, sputter rate calculation, 30 emission lines for 15 elements Fe/C/Cr/Ni/Mn/Si/Cu/Al/Ti/Mo/V/W/Co/N/O, multi-point calibration with matrix correction, depth profile construction, interface detection, coating analysis Zn/Cr/CrN presets, Boltzmann self-absorption correction, spectral interference correction, SPC control charts) (933 total)
  - All blocks wired into the visual pipeline builder (now 933 blocks) with property editors and block metadata
