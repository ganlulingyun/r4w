...
- **GNU Radio Feature Parity (Batches 13-54)** — 210+ new DSP modules bringing the total to ~242+ standalone blocks with ~2670+ unit tests:
  ...
  - All blocks wired into the visual pipeline builder (now 268+ blocks) with property editors and block metadata
