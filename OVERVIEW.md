...
- **GNU Radio Feature Parity (Batches 13-53)** — 205+ new DSP modules bringing the total to ~237+ standalone blocks with ~2620+ unit tests:
  ...
  - All blocks wired into the visual pipeline builder (now 253+ blocks) with property editors and block metadata
