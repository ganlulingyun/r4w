...
- **GNU Radio Feature Parity (Batches 13-52)** — 200+ new DSP modules bringing the total to ~232+ standalone blocks with ~2560+ unit tests:
  ...
  - All blocks wired into the visual pipeline builder (now 248+ blocks) with property editors and block metadata
