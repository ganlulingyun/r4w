...
RUN mkdir -p crates/r4w-core/src crates/r4w-sim/src crates/r4w-cli/src \
    crates/r4w-fpga/src crates/r4w-gui/src crates/r4w-web/src crates/r4w-sandbox/src && \
...
RUN touch crates/r4w-cli/src/main.rs crates/r4w-core/src/lib.rs \
    crates/r4w-sim/src/lib.rs crates/r4w-fpga/src/lib.rs \
...
COPY --from=builder /build/examples /app/examples 2>/dev/null || true
